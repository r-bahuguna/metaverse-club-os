...
export const MOCK_SHIFTS: Shift[] = [
    // Today
    { id: 'shift-001', staffId: 'staff-003', staffName: 'DJ Alexa', role: 'dj', date: getDateStr(0), startTime: '20:00', endTime: '00:00', status: 'active', response: 'accepted', notes: 'Neon Nights theme' },
    { id: 'shift-002', staffId: 'staff-005', staffName: 'Sasha', role: 'host', date: getDateStr(0), startTime: '19:00', endTime: '01:00', status: 'active', response: 'accepted' },
    { id: 'shift-003', staffId: 'staff-007', staffName: 'Kai', role: 'manager', date: getDateStr(0), startTime: '18:00', endTime: '02:00', status: 'active', response: 'accepted' },
    // Tomorrow
    { id: 'shift-004', staffId: 'staff-004', staffName: 'DJ Neon', role: 'dj', date: getDateStr(1), startTime: '22:00', endTime: '04:00', status: 'scheduled', response: 'pending' },
    { id: 'shift-005', staffId: 'staff-006', staffName: 'Miko', role: 'host', date: getDateStr(1), startTime: '20:00', endTime: '02:00', status: 'scheduled', response: 'accepted' },
    { id: 'shift-006', staffId: 'staff-007', staffName: 'Kai', role: 'manager', date: getDateStr(1), startTime: '19:00', endTime: '03:00', status: 'scheduled', response: 'accepted' },
    // Day after
    { id: 'shift-007', staffId: 'staff-003', staffName: 'DJ Alexa', role: 'dj', date: getDateStr(2), startTime: '21:00', endTime: '01:00', status: 'scheduled', response: 'accepted', notes: 'Ladies Night' },
    { id: 'shift-008', staffId: 'staff-005', staffName: 'Sasha', role: 'host', date: getDateStr(2), startTime: '20:00', endTime: '02:00', status: 'scheduled', response: 'reschedule_requested' },
    // 3 days out
    { id: 'shift-009', staffId: 'staff-004', staffName: 'DJ Neon', role: 'dj', date: getDateStr(3), startTime: '22:00', endTime: '04:00', status: 'scheduled', response: 'pending' },
    { id: 'shift-010', staffId: 'staff-006', staffName: 'Miko', role: 'host', date: getDateStr(3), startTime: '21:00', endTime: '03:00', status: 'scheduled', response: 'declined' },
];
...
export const MOCK_TIPS: TipRecord[] = [
    { id: 'tip-001', timestamp: '2026-02-11T11:55:00Z', amount: 500, tipperName: 'CoolCat42', recipientId: 'staff-003', recipientName: 'DJ Alexa', category: 'dj', source: 'DG-T 100s DJ Jar' },
    { id: 'tip-002', timestamp: '2026-02-11T11:50:00Z', amount: 200, tipperName: 'NightOwl88', recipientId: 'staff-005', recipientName: 'Sasha', category: 'host', source: 'DG-T 100s Host Jar' },
    ...
    { id: 'tip-004', timestamp: '2026-02-11T11:40:00Z', amount: 300, tipperName: 'DancerFan', recipientId: 'staff-003', recipientName: 'DJ Alexa', category: 'dj', source: 'DG-T 100s DJ Jar' },
    { id: 'tip-005', timestamp: '2026-02-11T11:30:00Z', amount: 150, tipperName: 'WanderlustSL', recipientId: 'staff-005', recipientName: 'Sasha', category: 'host', source: 'DG-T 100s Host Jar' },
...
export const MOCK_STAFF_FEED: StaffFeedMessage[] = [
    ...
    { id: 'feed-002', type: 'message', message: 'DJ Alexa: switching to Synthwave set next', timestamp: '2026-02-11T11:48:00Z' },
    ...
    { id: 'feed-005', type: 'message', message: 'Sasha: new guest needs orientation', timestamp: '2026-02-11T11:38:00Z' },
...
export const MOCK_AVAILABILITY: Availability[] = [
    { id: 'avail-001', staffId: 'staff-003', staffName: 'DJ Alexa', role: 'dj', date: getDateStr(4), startTime: '19:00', endTime: '01:00' },
    { id: 'avail-002', staffId: 'staff-003', staffName: 'DJ Alexa', role: 'dj', date: getDateStr(5), startTime: '20:00', endTime: '02:00' },
    { id: 'avail-003', staffId: 'staff-004', staffName: 'DJ Neon', role: 'dj', date: getDateStr(4), startTime: '21:00', endTime: '03:00' },
    { id: 'avail-004', staffId: 'staff-004', staffName: 'DJ Neon', role: 'dj', date: getDateStr(6), startTime: '22:00', endTime: '04:00' },
    { id: 'avail-005', staffId: 'staff-005', staffName: 'Sasha', role: 'host', date: getDateStr(4), startTime: '18:00', endTime: '00:00' },
    { id: 'avail-006', staffId: 'staff-005', staffName: 'Sasha', role: 'host', date: getDateStr(5), startTime: '19:00', endTime: '01:00' },
    { id: 'avail-007', staffId: 'staff-006', staffName: 'Miko', role: 'host', date: getDateStr(5), startTime: '20:00', endTime: '02:00' },
    { id: 'avail-008', staffId: 'staff-006', staffName: 'Miko', role: 'host', date: getDateStr(6), startTime: '21:00', endTime: '03:00' },
];

/** ── Smart Schedule Pairings ── */
export const MOCK_PAIRINGS: SchedulePairing[] = [
    { id: 'pair-001', eventId: 'event-004', eventName: 'Techno Tuesday', date: getDateStr(4), djId: 'staff-003', djName: 'DJ Alexa', hostId: 'staff-005', hostName: 'Sasha', status: 'proposed' },
    { id: 'pair-002', eventId: 'event-005', eventName: 'Chill Friday', date: getDateStr(5), djId: 'staff-003', djName: 'DJ Alexa', hostId: 'staff-006', hostName: 'Miko', status: 'proposed' },
    { id: 'pair-003', eventId: 'event-006', eventName: 'Weekend Rave', date: getDateStr(6), djId: 'staff-004', djName: 'DJ Neon', hostId: 'staff-006', hostName: 'Miko', status: 'proposed' },
];
