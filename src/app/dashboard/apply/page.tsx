    ...
    return (
        <div style={{
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
                    ...
                    <div>
                        ...
                        <textarea value={experience} onChange={e => setExperience(e.target.value)}
                            placeholder={role === 'host'
                                ? 'Tell us about your hosting experience — events, clubs, SL venues, etc.'
                                : 'Tell us about your DJ experience — sets, genres, SL venues, etc.'}
                    ...
                    <div>
                        ...
                        <input value={genres} onChange={e => setGenres(e.target.value)}
                            placeholder="e.g. House, Techno, Hip-Hop, Pop, All genres" style={inputStyle}
                            onFocus={e => { e.target.style.borderColor = 'rgba(0,240,255,0.4)'; e.target.style.boxShadow = '0 0 0 3px rgba(0,240,255,0.08)'; }}
                            onBlur={e => { e.target.style.borderColor = 'rgba(255,255,255,0.08)'; e.target.style.boxShadow = 'none'; }}
                        />
                    </div>
                    <div>
                        ...
                        <input value={sampleLink} onChange={e => setSampleLink(e.target.value)}
                            placeholder="https://soundcloud.com/your-mix or YouTube link" style={inputStyle}
                            onFocus={e => { e.target.style.borderColor = 'rgba(0,240,255,0.4)'; e.target.style.boxShadow = '0 0 0 3px rgba(0,240,255,0.08)'; }}
                            onBlur={e => { e.target.style.borderColor = 'rgba(255,255,255,0.08)'; e.target.style.boxShadow = 'none'; }}
                        />
                    </div>
            ...
            {step === 4 && (
                <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
                    <div style={{ ...labelStyle, justifyContent: 'center', fontSize: 14, marginBottom: 4 }}>
                        Anything else? Then review & submit
                    </div>
                    <div>
